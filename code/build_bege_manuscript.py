...
AI_DECLARATION_119 = "Generative artificial intelligence tools were used to support language editing, organization and formatting. The author reviewed, verified and takes responsibility for the final content."
...
def build_manuscript():
    ...
    p(doc, f"Use of generative artificial intelligence: {AI_DECLARATION_119}")
